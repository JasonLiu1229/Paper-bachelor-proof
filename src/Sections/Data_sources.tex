...
\begin{document}
    ...
    The data that are becoming available are based on a range of high-resolution forecasts (HRES \- 9 km horizontal resolution) and ensemble forecasts (ENS – 18 km horizontal resolution). They will be made accessible at a resolution of 0.4 x 0.4 degrees \cite{ecmwf_data_free}.\\
    \\\\
