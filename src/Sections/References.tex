...
\begin{thebibliography}{00}
    ...
    \bibitem{c1} Introduction to ClimaX: The first foundation model for weather and climate [Online]
    ...
    \bibitem{c2} ECMWF ERA5 Climate reanalysis [Online] https://climate.copernicus.eu/climate-reanalysis
